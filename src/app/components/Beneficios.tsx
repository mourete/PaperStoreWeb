      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex overflow-x-auto gap-6 sm:gap-8 pb-4 scrollbar-hide justify-center">
          {visibleServices.map((service, index) => (
            <div
              key={index}
              className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 sm:p-6 text-center flex flex-col items-center transform transition-transform duration-300 hover:scale-105 w-80 flex-shrink-0" // Ancho fijo para las tarjetas en el carrusel y flex-shrink-0
            >
              <img
                src={service.image}
                alt={service.title}
        ...
        <div className="absolute top-1/2 left-0 transform -translate-y-1/2 sm:-translate-y-1/2">
          <button
            onClick={prevGroup}
        ...
        <div className="absolute top-1/2 right-0 transform -translate-y-1/2 sm:-translate-y-1/2">
          <button
            onClick={nextGroup}
